...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <input type="text" name="nome" id="inome"><span>*</span><br><br>

        <label for="iemail">Email: </label>
        <input type="email" name="email" id="iemail"><span>*</span><br><br>

        <label for="iwebsite">Website</label>
        <input type="text" name="website" id="iwebsite"><span></span><br><br>

        <label for="itexto">Comentário</label>
        <textarea name="comentario" id="itexto" cols="30" rows="10"></textarea><br><br>
        ...
        <input type="radio" name="genero" id="ioutro"><span>* </span>
        <br><br>
