...
<body>
    <ul>
        <li><a href="classFruta.php" title="Classe em php orientado a objetos">classe em php</a></li>
        <li><a href="construct.php" title="Métodos construtores em php POO">Construtor em php</a></li>
        <li><a href="destruct.php" title="Métodos destrutores em php POO">destruct em php</a></li>
        <li><a href="modificador_acesso.php" title="Modificadores de acesso em php. ex: public, protected e private">Modificador de acesso em php</a></li>
        <li><a href="heranca.php" title="Herança de classes em php. ex: Morango extends Fruits">Herança em PHP</a></li>
        ...
        <li><a href="iterables.php" title="Iteradores em php para percorrer um objeto">Iteráveis em PHP</a></li>
